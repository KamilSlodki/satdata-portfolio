...
- **Si vienes por una posición founding engineer / staff AI** → empieza por [`ipaas-automation-engineer-case-study`](https://github.com/KamilSlodki/ipaas-automation-engineer-case-study) (6 LLM agents en producción con guardrails) o [`conversational-voice-ai-platform-case-study`](https://github.com/KamilSlodki/conversational-voice-ai-platform-case-study) (2 motores voice AI conversacional con SIP BYOC enterprise). Después la sección [Track A](#track-a--ai-systems--production-llm) tiene los 10 showcases del track.
